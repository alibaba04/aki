...
<!--        <link rel="stylesheet" href="plugins/iCheck/flat/blue.css">-->
        ...
        <link rel="icon" href="dist/img/can.png" type="image/png"/>
                ...
                if ((isset($_SESSION["my"]) !== false) && (isset($_GET["page"]) !== "login_detail")) {
                    ...
                    <nav class="navbar navbar-static-top">
                        ...
                        <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
                            ...
                            <span style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;">Keuangan</span>
                        </a>
            ...
            if (isset($_SESSION["my"]) != false && isset($_GET["page"]) != "login_detail") {
                ...
                <footer class="main-footer">
                    ...
                    <div class="pull-right hidden-xs">
                        <b>Akuntansi App</b> v 1.0.1 &nbsp;&nbsp;<strong>Created by : <a href="http://instagram.com/baihaqial">alibaba</a>.
                    </div>
                    <strong>.</strong>
